...
const SimilarPokemon = () => {
  return (
    <div>
      <h2 className="text-lg font-bold mt-4 mb-4 text-center">Similar</h2>
      <div className="grid grid-cols-2 bg-slate-100 py-5 mx-7 text-center mb-1">
        <div className="border rounded-xl bg-white my-5 mx-2">
